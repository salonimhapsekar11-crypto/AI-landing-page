...
export const DSWorkshopsSection: React.FC = () => {
  return (
      ...
      <div className="container">
        ...
        <div style={{ textAlign: 'left', marginBottom: '2.75rem' }}>
          ...
          <p style={{
            ...
            Want to learn the workflow yourself? If you'd rather build the system with your team than hand it off, here's what's coming up.
          </p>
        </div>
